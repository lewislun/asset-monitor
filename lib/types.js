 ...
 * @property {string} [accountId] Auto patched by BaseAssetScanner. Value of this field in pseudo: query.addr ?? query.apiKey ?? query.apiSecret(censored) ?? undefined.
 ...
 * @property {AssetQueryJson[]} queries
 * 
 * @typedef ScanResult
