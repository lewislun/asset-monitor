...
import { logger, RateLimiter, PriceAggregator, isEnumMember } from './utils/index.js'
...
export default class AssetMonitor {
	...
	addAssetScanner(config) {
		...
		const scanner = new scannerClass(this.priceAggregator, assetInfoMap, config.params)
